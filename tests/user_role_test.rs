...
mod user_role_tests {
    ...
    async fn test_assign_roles_to_user() {
        ...
        let resp: common::resp::ApiResponse<AssignRolesRespDto> =
    ...
    async fn test_get_roles_of_user() {
        ...
        let resp: common::resp::ApiResponse<UserRolesRespDto> =
            test::call_and_read_body_json(&app, req).await;
    ...
    async fn test_delete_role_of_user() {
        ...
        let resp: common::resp::ApiResponse<RemoveRoleRespDto> =
            test::call_and_read_body_json(&app, req).await;
