...
mod role_permission_tests {
    ...
    async fn test_assign_permissions_to_role() {
        ...
        let resp: common::resp::ApiResponse<AssignPermissionsRespDto> =
    ...
    async fn test_get_permissions_of_role() {
        ...
        let resp: common::resp::ApiResponse<RolePermissionsRespDto> =
            test::call_and_read_body_json(&app, req).await;
    ...
    async fn test_remove_permission_from_role() {
        ...
        let resp: common::resp::ApiResponse<RemovePermissionRespDto> =
            test::call_and_read_body_json(&app, req).await;
